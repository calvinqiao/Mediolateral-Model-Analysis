...
% DOUBLEINTEGRATOR  Calculates center of mass in x direction.
%   [COM_TRACE] = DOUBLEINTEGRATOR(COPX, FX, MASS, DT) gets center of mass in x
%   direction by force plate data from trial.
    ...
    CoPSegs = cell(1, length(zeroCrosses) + 1);
    FxSegs = cell(1, length(zeroCrosses) + 1);
    ...
    CoM_trace = CoM_trace - mean(CoM_trace, 'omitnan');
