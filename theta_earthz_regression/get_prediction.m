...
%   theta_com). Prediction are made based on both old and theta_t regression
%   models.
% 
%   See also NEW_MODEL.
...
%   subject's movements.
    ...
    for i = 1:n_frames
        ...
        % theta_vert = theta_p + (pi / 2 - theta_t);
